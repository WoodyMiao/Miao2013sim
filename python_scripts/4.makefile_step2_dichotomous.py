...
logging.info(f'Start 4.makefile_step2_dichotomous.')
...
parser.add_argument('--prevalence-vals', type=str, required=True, help='prevalence values for the liability threshold '
                                                                       'modeling of dichotamous phenotypes')
...
parser.add_argument('--assoc-test', type=str, required=True, help='chi2|linear|logit, the part of the suffix of the '
                                                                  'input files indicating the association test.')
...
logging.info(f'Done 4.makefile_step2_dichotomous.')
